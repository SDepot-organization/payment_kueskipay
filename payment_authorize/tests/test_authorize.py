...
class AuthorizeForm(AuthorizeCommon):
	...
	def test_20_authorize_form_management(self):
		...
		authorize_post_data = {
			...
			'x_SHA2_Hash': '7D3AC844BE8CA3F649AB885A90D22CFE35B850338EC91D1A5ADD819A85FF948A3D777334A18CDE36821DC8F2B42A6E1950C1FF96B52B60F23201483A656195FB',
			'x_account_number': 'XXXX0027',
			'x_address': 'Huge Street 2/543',
			'x_amount': str(self.amount),
			'x_auth_code': 'E4W7IU',
			'x_avs_code': 'Y',
			'x_card_type': 'Visa',
			'x_cavv_response': '2',
